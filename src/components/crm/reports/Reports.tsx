    ...
    <>
      ...
      <div className="cx-lead-head" style={{ marginBottom: 18 }}>
        <div>
          <h1>報表</h1>
          <div className="sub">
            業績達成、銷售漏斗與活動量的整體分析 — 即時掌握團隊表現與管線健康度。
          </div>
        </div>
          ...
          <div className="cx-fpill">
            ...
            <select
              ...
              onChange={(e) => {
                ...
                showToast(`已切換期間 · ${e.target.value}`);
              }}
            >
              {PERIODS.map((p) => (
      ...
      <div className="cx-rpt-kpi-row">
        <div className="cx-rpt-kpi">
          ...
          <div className="kd">
            <span className="cx-trend up">
              <IconUp />
              18%
            </span>
            <span className="muted">較上季</span>
          </div>
        </div>
        <div className="cx-rpt-kpi">
          <div className="kl">
            <span className="cx-ki green">
              <IconTarget />
            </span>
            目標達成率
          </div>
          ...
          <div className="kd">
            ...
            <span className="muted">目標 NT$ 10M</span>
          </div>
        </div>
        <div className="cx-rpt-kpi">
          <div className="kl">
            <span className="cx-ki violet">
              <IconOpps />
            </span>
            新增商機
          </div>
          ...
          <div className="kd">
            ...
            <span className="muted">本季</span>
          </div>
        </div>
        <div className="cx-rpt-kpi">
          <div className="kl">
            <span className="cx-ki orange">
              <IconClock />
            </span>
            平均成交週期
          </div>
          <div className="kv">
            48 <span className="unit">天</span>
          </div>
          <div className="kd">
            <span className="cx-trend down">
              <IconDown />5 天
            </span>
            <span className="muted">縮短，越短越好</span>
          </div>
        </div>
      </div>
          ...
          <div className="cx-chart-head">
            ...
            <div className="cx-legend">
              <span className="cx-lg">
                <span className="sw" style={{ background: '#3B82F6' }} />
                實際
              </span>
              <span className="cx-lg">
                <span className="sw" style={{ background: '#dbe3ee' }} />
                目標
              </span>
            </div>
          </div>
        ...
        <div className="cx-chart-card">
          ...
          <div className="cx-gauge-wrap">
            ...
            <div className="cx-gauge-foot">
              <div className="gf">
                <div className="v">NT$ 8.6M</div>
                <div className="l">實際營收</div>
              </div>
              <div className="gf">
                <div className="v" style={{ color: 'var(--cx-text-sub)' }}>
                  NT$ 1.4M
                </div>
                <div className="l">尚差</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="cx-rpt-g2b">
        ...
        <div className="cx-chart-card">
          <div className="cx-chart-head">
            <div>
              <h3>銷售漏斗</h3>
              <div className="csub">本季各階段商機轉換</div>
            </div>
          </div>
        ...
        <div className="cx-chart-card">
          <div className="cx-chart-head">
            <div>
              <h3>商機來源分布</h3>
              <div className="csub">依首次接觸管道</div>
            </div>
          </div>
        ...
        <table className="cx-lb-tbl">
          ...
          <thead>
            <tr>
              <th>排名</th>
              <th>業務</th>
              <th className="num">已成交營收</th>
              <th className="num">成交數</th>
              <th>目標達成</th>
            </tr>
          </thead>
          <tbody>
            {LB.map((r, i) => {
              ...
              return (
                <tr key={r.who}>
                  <td>
                    <span className={`cx-rank r${i + 1}`}>{i + 1}</span>
                  </td>
                  <td>
                    <div className="cx-lb-rep">
                      <div className="av" style={{ background: a.g }}>
                        {a.av}
                      </div>
                      <div>
                  ...
                  <td>
                    <div className="cx-lb-amt">{r.amt}</div>
                  </td>
                  <td>
                    <div className="cx-num-cell">{r.deals}</div>
                  </td>
                  <td>
