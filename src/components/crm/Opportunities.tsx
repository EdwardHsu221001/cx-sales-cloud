...
const INIT_OPPS: Opp[] = [
  { id: 1,  title: '2026 智慧製造平台導入', co: 'tsmc',  amt: 2400, prob: 65, close: '2026/07/30', owner: 'zhang', stage: 'negotiate' },
  { id: 2,  title: '雲端研發環境建置',       co: 'mtk',   amt: 1800, prob: 60, close: '2026/07/18', owner: 'chen',  stage: 'negotiate' },
  { id: 3,  title: '資安監控系統擴充',       co: 'tsmc',  amt: 1200, prob: 45, close: '2026/08/15', owner: 'zhang', stage: 'proposal' },
  { id: 4,  title: '供應鏈管理系統升級',     co: 'fox',   amt: 2000, prob: 40, close: '2026/08/05', owner: 'lin',   stage: 'proposal' },
  { id: 5,  title: '能源管理儀表板專案',     co: 'delta', amt: 900,  prob: 50, close: '2026/08/12', owner: 'chen',  stage: 'proposal' },
  { id: 6,  title: '資料分析平台導入',       co: 'mtk',   amt: 1000, prob: 35, close: '2026/08/28', owner: 'chen',  stage: 'proposal' },
  { id: 7,  title: '年度技術支援續約',       co: 'tsmc',  amt: 600,  prob: 25, close: '2026/09/10', owner: 'zhang', stage: 'need' },
  { id: 8,  title: '倉儲自動化整合案',       co: 'fox',   amt: 1100, prob: 20, close: '2026/09/22', owner: 'lin',   stage: 'need' },
  { id: 9,  title: 'IoT 設備監控擴充',      co: 'delta', amt: 500,  prob: 15, close: '2026/09/30', owner: 'chen',  stage: 'need' },
  { id: 10, title: '緯創資通 — 新商機',     co: 'wis',   amt: 900,  prob: 10, close: '2026/07/15', owner: 'zhang', stage: 'need' },
  { id: 11, title: '全球客服系統整合',       co: 'asus',  amt: 1500, prob: 100, close: '2026/06/01', owner: 'zhang', stage: 'won' },
  { id: 12, title: '舊機房維運轉案',         co: 'fox',   amt: 700,  prob: 0,  close: '2026/05/20', owner: 'lin',   stage: 'lost' },
]
...
function IconExport() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M12 15V3M7 8l5-5 5 5" /><path d="M5 21h14" />
    </svg>
  )
}
function IconPlus() {
...
function IconTarget() {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M12 2a10 10 0 1 0 10 10" /><path d="M12 12 22 2" /><path d="M12 7v5h5" />
    </svg>
  )
}
    ...
    <>
      ...
      <div className="cx-stat-bar">
        <div className="cx-stat">
          <div className="cx-sic blue"><IconTrendUp /></div>
          <div>
        ...
        <div className="cx-stat">
          <div className="cx-sic violet"><IconTarget /></div>
          <div>
        ...
        <div className="cx-stat">
          <div className="cx-sic green"><IconCheckMark /></div>
          <div>
        ...
        <div className="cx-stat">
          <div className="cx-sic orange"><IconBarChart /></div>
          <div>
      ...
      <div className="cx-filter-row">
        ...
        <div className="cx-filter-count">共 <b>{opps.length}</b> 筆商機</div>
      </div>
            ...
            return (
              ...
              >
                <div className="cx-col-head">
                  ...
                  <div className="ch-sum"><b>{fmtM(sum)}</b></div>
                </div>
                  ...
                  {items.map(opp => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="oc-co">
                          <span className="oc-logo" style={{ background: co.g }}>{co.logo}</span>
      ...
      {view === 'list' && (
        <div className="cx-opp-list-card">
          <table className="cx-op-tbl">
            ...
            <tbody>
              {[...opps].sort((a, b) => b.amt - a.amt).map(opp => {
                const co = CO[opp.co]
                const own = ASSIGNEES[opp.owner]
                  ...
                  <tr key={opp.id} onClick={() => showToast('開啟商機 · ' + opp.title)}>
                    <td>
                      <div className="cx-op-co">
                        <div className="lg" style={{ background: co.g }}>{co.logo}</div>
                        <div className="txt">
                    ...
                    <td><span className="cx-op-close">{opp.close}</span></td>
                    <td>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8, minWidth: 0 }}>
                        <div
                          style={{
                            width: 26, height: 26, borderRadius: '50%',
                            background: own.g, display: 'grid', placeItems: 'center',
